...
void GuiWindowAbout(GuiWindowAboutState *state)
{
    ...
    const char *lblNameVersionText = "rIconPacker v1.0";
    ...
    if (state->windowAboutActive)
    {
        ...
        if (GuiButton((Rectangle){ state->position.x + 175, state->position.y + 305, 75, 25 }, BtnBeONEText)) { OpenURL("https://raylibtech.itch.io/riconpacker"); }
#endif
